...
if __name__ == '__main__':
    ...
    if(os.path.isfile(xbmcvfs.translatePath('special://skin/1080i/script-screensaver-digitalclock-custom.xml'))):
        screensaver = Screensaver('script-screensaver-digitalclock-custom.xml', xbmcvfs.translatePath('special://skin/1080i/'), 'default')
    elif(os.path.isfile(xbmcvfs.translatePath('special://skin/720p/script-screensaver-digitalclock-custom.xml'))):
        screensaver = Screensaver('script-screensaver-digitalclock-custom.xml', xbmcvfs.translatePath('special://skin/720p/'), 'default')
    elif(os.path.isfile(xbmcvfs.translatePath('special://skin/21x9/script-screensaver-digitalclock-custom.xml'))):
        screensaver = Screensaver('script-screensaver-digitalclock-custom.xml', xbmcvfs.translatePath('special://skin/21x9/'), 'default')
    elif(os.path.isfile(xbmcvfs.translatePath('special://skin/16x9/script-screensaver-digitalclock-custom.xml'))):
        screensaver = Screensaver('script-screensaver-digitalclock-custom.xml', xbmcvfs.translatePath('special://skin/16x9/'), 'default')
    elif(os.path.isfile(xbmcvfs.translatePath('special://skin/4x3Hirez/script-screensaver-digitalclock-custom.xml'))):
        screensaver = Screensaver('script-screensaver-digitalclock-custom.xml', xbmcvfs.translatePath('special://skin/4x3Hirez/'), 'default')
